    ...
    return(
        <div>
            <div style={{pointerEvents:(loading)?'none':null, filter:(loading)?'blur(1px)':null}}>
                <Navbar realPage={realPage} currentPage={(!scrollInAboutUs)?realPage:'about_us'} handleLoading={handleLoading} scrollLocation={scrollRef} handleScrollAboutUs={handleScrollAboutUs} handleScrollUp={handleScrollUp}/>
...
export default ViewExersicePage;